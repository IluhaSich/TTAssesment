...
//    private final TimeTableParser timeTableParser; //TODO: Ну сервис больше не работает
    private final EvaluationService evaluationService;
    private final TTAService ttaService;

    public TimeTableController(EvaluationService evaluationService, TTAService ttaService) {
